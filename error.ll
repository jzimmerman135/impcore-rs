...
entry:
  ...
  call void @llvm.memset.p0i8.i32(i8* align 4 %1, i8 0, i32 mul (i32 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32), i32 4), i1 false)
  store i32* %array, i32** @"message[", align 8
  %printres = call i32 @println(i32 4)
  ret i32 4
}
...
entry:
  ...
  %userfn = call i32 @word(i32 92, i32 110, i32 10, i32 0)
  store i32 %userfn, i32* %index, align 4
  %printres = call i32 @println(i32 %userfn)
  ret i32 %userfn
}
...
define i32 @word.5(i32 %a, i32 %b, i32 %c, i32 %d) {
word:
