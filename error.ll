...
DEBUG:
  ...
  %print = tail call i32 @print(i32 %x)
  %userfn2 = tail call i32 @printc(i32 10)
  ret i32 %x
}
...
define i32 @val.2() {
entry:
  store i32 256, i32* @bufsize, align 4
  %printres = call i32 @println(i32 256)
  ret i32 256
}

define i32 @val.3() {
entry:
  %load = load i32, i32* @bufsize, align 4
  %load1 = load i32*, i32** @"mybuf[", align 8
  %0 = bitcast i32* %load1 to i8*
  tail call void @free(i8* %0)
  %bytes = mul i32 %load, ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32)
  %mallocsize = mul i32 %load, ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32)
...
entry:
  ...
  %load1 = load i32, i32* @bufsize, align 4
  %userfn = call i32 @readstr(i32* %load, i32 %load1, i32 0)
  %printres = call i32 @println(i32 %userfn)
  ret i32 %userfn
}
